<script lang="ts">
  // Simplified sidebar for lighten-up
</script>
...
>
  <div
    class="h-20 flex items-center justify-center w-full border-b border-slate-700/50 mb-4"
  >
    <div
  ...
  <nav
    class="flex-1 w-full px-3 space-y-4 flex flex-col items-center overflow-y-auto"
  >
    <button
      class="h-12 w-12 flex items-center justify-center rounded-xl bg-primary text-white shadow-lg shadow-primary/25 hover:scale-105 transition-all group relative"
      type="button"
      title="Active Lights"
    >
      <span class="text-2xl">💡</span>
  ...
  <div
    class="mt-auto pt-4 border-t border-slate-700/50 w-full flex justify-center"
  >
    <button
